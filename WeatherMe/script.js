...
const API_KEY = "22a35d40c46c45a304964227d745ff25";
    ...
    navigator.geolocation.getCurrentPosition(
        ...
        error => { // Show alert if user denied the location permission
            if (error.code === error.PERMISSION_DENIED) {
                alert("Geolocation request denied. Please change location permission to grant access again.");
            } else {
                alert("Geolocation request error. Please change location permission.");
            }
        });
}
